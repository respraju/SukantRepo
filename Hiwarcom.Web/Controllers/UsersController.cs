...
using Hiwarcom.Infrastructure;
using Hiwarcom.Infrastructure.Repositories;

namespace Hiwarcom.Web.Controllers
{
    public class UsersController : Controller
    {
        //private HiwarcomManagerDataContext db = new HiwarcomManagerDataContext();
